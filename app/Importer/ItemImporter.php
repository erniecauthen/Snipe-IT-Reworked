...
class ItemImporter extends Importer
{
    ...
    protected function handle($row)
    {
        ...
        $this->item["manufacture_date"] = null;
        if ($this->findCsvMatch($row, "manufacture_date")!='') {
            $this->item["manufacture_date"] = date("Y-m-d 00:00:01", strtotime($this->findCsvMatch($row, "manufacture_date")));
        }        
