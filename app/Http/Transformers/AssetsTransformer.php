...
class AssetsTransformer
{
    ...
    public function transformAsset(Asset $asset)
    {
        $array = [
            ...
            'asset_depreciation' => ($asset->purchase_date!='') ? Helper::getFormattedDateObject($asset->present()->depreciation_date(), 'date') : null ,
            ...
            'manufacture_date' => Helper::getFormattedDateObject($asset->manufacture_date, 'date'),
