              ...
              <div class="table-responsive" style="margin-top: 10px;">
                <table class="table">
                  <tbody>
                    ...
                    @if ($asset->manufacture_date)
                      <tr>
                        <td>{{ trans('admin/hardware/form.manufacture_date') }}</td>
                        <td>
                          {{ \App\Helpers\Helper::getFormattedDateObject($asset->manufacture_date, 'date', false) }}
                        </td>
                      </tr>
                    @endif
                    ...
                    @if (($asset->model) && ($asset->model->asset_depreciation))
                      <tr>
