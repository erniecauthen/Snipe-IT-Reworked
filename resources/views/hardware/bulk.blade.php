      ...
      <div class="box box-default">
        <div class="box-body">
          ...
          <div class="form-group {{ $errors->has('manufacture_date') ? ' has-error' : '' }}">
            ...
            <div class="input-group col-md-3">
              <input type="date" class="datepicker form-control" data-date-format="yyyy-mm-dd" placeholder="Select Date" name="manufacture_date" id="manufacture_date" value="{{ Input::old('manufacture_date') }}">
              <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
